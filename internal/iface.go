...
func newComplexParser(v any) EnvParser {
	...
	case []complex64:
		return complexSliceParser[complex64]{}
	case complex128:
		return complexParser[complex128]{}
	case []complex128:
		return complexSliceParser[complex128]{}
	default:
		return nil
	}
}
...
func newIntParser(v any) EnvParser {
	...
	case []int:
		return numberSliceParser[int]{}
	case int8:
		return numberParser[int8]{}
	case []int8:
		return numberSliceParser[int8]{}
	case int16:
		return numberParser[int16]{}
	case []int16:
		return numberSliceParser[int16]{}
	case int32:
		return numberParser[int32]{}
	case []int32:
		return numberSliceParser[int32]{}
	case int64:
		return numberParser[int64]{}
	case []int64:
		return numberSliceParser[int64]{}
	default:
		return nil
	}
}
...
func newUintParser(v any) EnvParser {
	...
	case []uint8:
		return numberSliceParser[uint8]{}
	case uint:
		return numberParser[uint]{}
	case []uint:
		return numberSliceParser[uint]{}
	case uint16:
		return numberParser[uint16]{}
	case []uint16:
		return numberSliceParser[uint16]{}
	case uint32:
		return numberParser[uint32]{}
	case []uint32:
		return numberSliceParser[uint32]{}
	case uint64:
		return numberParser[uint64]{}
	case []uint64:
		return numberSliceParser[uint64]{}
	case uintptr:
		return numberParser[uintptr]{}
	case []uintptr:
		return numberSliceParser[uintptr]{}
	default:
		return nil
	}
}
...
func newFloatParser(v any) EnvParser {
	...
	case []float32:
		return numberSliceParser[float32]{}
	case float64:
		return numberParser[float64]{}
	case []float64:
		return numberSliceParser[float64]{}
	default:
		return nil
	}
}
...
type numberSliceParser[T Number] struct{}

func (i numberSliceParser[T]) ParseEnv(key string, options Parameters) (any, error) {
	sep := options.Separator

	return getNumberSliceGen[T](key, sep)
}
...
type complexSliceParser[T Complex] struct{}

func (i complexSliceParser[T]) ParseEnv(key string, options Parameters) (any, error) {
	sep := options.Separator

	return getComplexSliceGen[T](key, sep)
}
